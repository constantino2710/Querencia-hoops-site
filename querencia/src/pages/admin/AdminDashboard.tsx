...
export default function AdminDashboard() {
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="bg-[rgb(var(--surface))] p-4 md:p-6 rounded-2xl shadow-sm border border-border">
        <h2 className="text-lg md:text-xl font-bold text-text-primary mb-4 md:mb-6">Visão Geral da Plataforma</h2>

...
export function Sidebar({ isCollapsed, setIsCollapsed }: SidebarProps) {
  ...
  return (
    ...
    >
      <div className="h-16 flex items-center justify-between px-4 border-b border-border shrink-0 overflow-hidden">
        {!isCollapsed && (
        ...
        <button
          ...
          className={`p-2 rounded-lg text-text-secondary hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors ${isCollapsed ? 'mx-auto' : ''}`}
        >
      ...
      <div className={`p-4 border-t border-border bg-gray-50/50 dark:bg-gray-800/20 shrink-0 flex flex-col gap-1 mt-auto ${isCollapsed ? 'items-center px-2' : ''}`}>
        <button
          onClick={toggleTheme}
        ...
        {/* Passamos o estado para os subcomponentes se eles precisarem de esconder textos também */}
